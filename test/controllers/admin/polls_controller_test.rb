...
class Admin::PollsControllerTest < ActionController::TestCase
  ...
  test "should create poll" do
    assert_difference('Poll.count') do
      post :create, poll: { slug: @poll.slug, status: @poll.status, title: @poll.title }
    end

    assert_redirected_to admin_poll_path(assigns(:poll))
  end
  ...
  test "should update poll" do
    patch :update, id: @poll, poll: { slug: @poll.slug, status: @poll.status, title: @poll.title }
    assert_redirected_to admin_poll_path(assigns(:poll))
  end
